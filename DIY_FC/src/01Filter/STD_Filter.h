...
#define GYRO_LPF_FREQ 60.0f  // Increase from 40.0f
...
#define ACC_LPF_FREQ 60.0f   // Increase from 10.0f
...
struct SecondOrderLPF {
    ...
    void init(float sample_rate, float cutoff_freq, float damping = 0.707f) {
