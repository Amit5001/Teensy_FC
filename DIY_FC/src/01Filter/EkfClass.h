...
class EKF {
   ...
   public:
    ...
    Matrix3f Q = Matrix3f::Identity() * Q_sensor_error * Q_integration_error * Q_model_error * Q_disturbance_error * Q_unknown_error; // Process noise covariance matrix
    Matrix3f R = Matrix3f::Identity() * accel_noise_var * R_external_accel_error * R_vibration_error * R_nonlinear_error * R_alignment_error * R_temperature_error; // Measurement noise covariance matrix
